...
#include "x3dh_requirements/microECC/uECC.h"
#include "x3dh_requirements//opt32/crypto_aead.h"
#include "x3dh_requirements//sha/rfc6234/sha.h"
#include <time.h>
...
int main() {
    ...
    while (1) {
        ...
        numBytes = read(sockfd, prekey_bundle, PREKEY_BUNDLE_SIZE);
        if (numBytes < 0) {
